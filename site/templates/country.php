...
<?php endif?>
	...
	<?php if ($page->testimonials && $page->testimonials->count()): ?>
	<!-- Start testimonials area -->
	<div class="testimonial-area4">
		<div class="container">
			<div class="recent-post4-title text-center">
				<h1>What Our Clients Say</h1>
				<p>Trusted by businesses across the region</p>
			</div>
			<div class="testimonials-carousel owl-carousel">
				<?php foreach ($page->testimonials as $testimonial):
					$img = ($testimonial->image) ? $testimonial->image->size(100, 100)->url : $urls->templates . 'img/default-avatar.png';
				?>
				<div class="single-testimonial">
					<div class="testimonial-box">
						<img src="<?php echo $img; ?>" alt="<?php echo $testimonial->testimonial_author; ?>">
						<p><?php echo $testimonial->testimonial_text; ?></p>
						<span class="quote"><i class="fa fa-quote-right"></i></span>
					</div>
					<div class="testimonial-details">
						<h5><?php echo $testimonial->testimonial_author; ?></h5>
						<p><?php echo $testimonial->testimonial_role; ?></p>
					</div>
				</div>
				<?php endforeach; ?>
			</div>
	...
	<?php if ($page->company_profile_pdf): ?>
	<!-- Start Company PDF Download -->
	<div class="company-pdf-area py-4">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-12 col-md-6 text-center">
					<a href="<?php echo $page->company_profile_pdf->url; ?>" class="readon large border" target="_blank" download>
